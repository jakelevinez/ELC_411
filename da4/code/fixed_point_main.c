...
{
    return uint32_t intfromfixed = (fix + FIX__0_5)>>16;
}
...
{
    return double doublefromfixed = (fix>>16);
}
...
{
    return uint32_t fixedfromdouble = (x)
}
...
int main()
{
    ...
    for(;;)
    {
        ...
        // *****************************************************************************************
        //      Add your code here to read digital input pin and pass state along ...
        // *****************************************************************************************
